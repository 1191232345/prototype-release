...
3. 阶段一确认语：**「需求理解正确，继续细化」**；阶段二确认语：**「理解正确，继续创建」**
...
|------|------|
| 项目名称 | SKU 信息填充 PDA 端 |
| 目录 slug | sku-信息填充-pda |
| 版本 | v1 |
| 目标目录 | prototypes/sku-信息填充-pda/v1/ |
...
- `npm run acceptance:gen -- sku-信息填充-pda/v1`
- `npm run prompts:gen -- sku-信息填充-pda/v1`
