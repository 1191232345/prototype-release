...
export const ProjectDocPanel = forwardRef(function ProjectDocPanel({ project, tab: _tab, embedded = false, dense = false, pageScope = null, highlightKey = null, highlightTableRow = null, locateToken = 0, interactive = false, onPrdPick, editable = false, sectionEditor, originalPrdText, }, ref) {
    ...
    return (_jsx("div", { ref: ref, className: `flex-1 overflow-auto min-w-0 bg-surface ${embedded ? 'min-h-0' : ''}`, children: _jsx("div", { className: dense
                ...
                : embedded
                    ? 'px-3 sm:px-4 py-3'
                    : 'max-w-6xl mx-auto px-4 sm:px-6 py-4 sm:py-6', children: prd ? (_jsx(PrdDocView, { text: prd, compact: embedded, dense: dense, pageScope: pageScope, highlightKey: highlightKey, highlightTableRow: highlightTableRow, locateToken: locateToken, scrollContainerRef: scrollContainerRef, interactive: interactive, onPrdPick: onPrdPick, editable: editable, sectionEditor: sectionEditor, project: project, originalPrdText: originalPrdText })) : (_jsx(EmptyDoc, { icon: "fa-file-contract", title: "\u6682\u65E0 PRD", hint: "\u521B\u5EFA\u6216\u8FED\u4EE3\u65F6 AI \u53EF\u5199\u5165 PRD.md\uFF08\u4EA7\u54C1\u9700\u6C42\u89C4\u683C\uFF09" })) }) }));
});
