const EXACT_RULES = [
    ...
    { id: 'form.warehouse.chips', anchorId: 'form.warehouse-split', keywords: ['适用仓库', 'Chips'] },
    { id: 'form.fee.empty', anchorId: 'form.quick-fill', keywords: ['费用空状态'] },
    { id: 'form.fee.manual', anchorId: 'form.interaction', keywords: ['手动配置'] },
    { id: 'form.fee.progress', anchorId: 'form.fee-nav', keywords: ['配置进度'] },
    { id: 'list.fee-type.tabs', anchorId: 'list.fee-type-tabs', keywords: ['费用类型 Tab'] },
    { id: 'form.warehouse.select-all', anchorId: 'form.warehouse-split', keywords: ['适用仓库', '全选'] },
    { id: 'form.warehouse.clear-all', anchorId: 'form.warehouse-split', keywords: ['适用仓库', '取消全选'] },
    ...
    { id: 'task.sku-form', anchorId: 'form.fields', keywords: ['表单字段说明'] },
    { id: 'task.instruction.sheet', anchorId: 'form.interaction', keywords: ['表单交互逻辑'] },
    { id: 'form.surcharge.table', anchorId: 'form.surcharge-table', keywords: ['费用项表格'] },
    { id: 'form.other.table', anchorId: 'form.other-table', keywords: ['其他费用'] },
    { id: 'form.zone.btn.delete', anchorId: 'form.zone-table', keywords: ['分区报价', '操作列'] },
...
const PREFIX_RULES = [
    ...
    { prefix: 'list.fee-type.tab.', anchorId: 'list.fee-type-tabs', keywords: ['费用类型 Tab'] },
    ...
    { prefix: 'task.info.', anchorId: 'form.init', keywords: ['初始化与数据展示逻辑'] },
    { prefix: 'task.sku.', anchorId: 'form.fields', keywords: ['表单字段说明'] },
    { prefix: 'task.instruction.', anchorId: 'form.interaction', keywords: ['表单交互逻辑'] },
    { prefix: 'task.btn.', anchorId: 'form.main-buttons', keywords: ['主要按钮说明'] },
    { prefix: 'task.', anchorId: 'form.init', keywords: ['初始化与数据展示逻辑'] },
    ...
    { prefix: 'form.surcharge.field.', anchorId: 'form.surcharge-table', keywords: ['附加费', '费用项'] },
    { prefix: 'form.other.field.', anchorId: 'form.other-table', keywords: ['其他费用', '费用项'] },
