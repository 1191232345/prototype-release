...
import { faArrowLeft, faBan, faBars, faBook, faBookOpen, faBorderAll, faBoxes, faBullseye, faCalculator, faCamera, faCheck, faCheckCircle, faCheckDouble, faChevronDown, faChevronLeft, faChevronRight, faChevronUp, faCircle, faClipboardCheck, faClipboardList, faClone, faCloudUploadAlt, faCodeBranch, faCog, faCoins, faCopy, faCrosshairs, faDesktop, faDownload, faEdit, faEllipsisH, faExchangeAlt, faExclamationCircle, faExclamationTriangle, faExternalLinkAlt, faEye, faFileAlt, faFileContract, faFileExcel, faFileImport, faFileInvoiceDollar, faFilter, faFolderOpen, faHandPointer, faHistory, faHourglassHalf, faImage, faInbox, faInfoCircle, faLayerGroup, faLightbulb, faLink, faListAlt, faListCheck, faMagic, faMinus, faMinusCircle, faMobileAlt, faMousePointer, faPalette, faPaperPlane, faPencilAlt, faPlayCircle, faPlus, faRedo, faRobot, faRoad, faSearch, faSitemap, faSlidersH, faSpinner, faStream, faSyncAlt, faTable, faTimes, faTrash, faUndo, faUpload, faUsers, faWarehouse, faWindowMaximize, faCogs, } from '@fortawesome/free-solid-svg-icons';
const ICON_MAP = {
