...
export function PreviewPanel({ project, loading = false }) {
    ...
    if (project.status === 'pending') {
        ...
        return (_jsx(PreviewFrame, { project: project, children: _jsx(EmptyState, { icon: hasSpecErrors ? 'fa-triangle-exclamation' : 'fa-hourglass-half', title: project.meta.title, description: hasSpecErrors
