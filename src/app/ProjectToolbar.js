...
export function ProjectToolbar({ project, immersive = false, publishConfigured = false, publishing = false, onMenuClick, onEdit, onDelete, onIterate, onPublish, }) {
    if (!project) {
        return (_jsx("header", { className: "shrink-0 bg-white border-b border-border-light relative z-30", children: _jsxs("div", { className: "min-h-10 flex items-center gap-2 px-3 sm:px-5 py-2", children: [_jsx("button", { type: "button", className: "toolbar-icon-btn lg:hidden shrink-0", title: "\u6253\u5F00\u9879\u76EE\u5217\u8868", onClick: onMenuClick, children: _jsx(FaIcon, { className: "fas fa-bars" }) }), _jsx("p", { className: "text-sm text-text-muted", children: "\u2190 \u9009\u62E9\u9879\u76EE\u5F00\u59CB\u9884\u89C8" })] }) }));
    }
